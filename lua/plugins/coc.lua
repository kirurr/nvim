return {
	...
	init = function()
		...
		keyset("n", "<leader>f", "<Plug>(coc-format-selected)", { silent = true, desc = "Format selected" })
		...
		keyset("x", "<leader>a", "<Plug>(coc-codeaction-selected)", { silent = true, nowait = true, desc = "Codeaction selected" })
		keyset("n", "<leader>a", "<Plug>(coc-codeaction-selected)", { silent = true, nowait = true, desc = "Codeaction selected" })

		keyset("n", "<leader>ac", "<Plug>(coc-codeaction-cursor)", { silent = true, nowait = true, desc = "Codeaction cursor" })
		keyset("n", "<leader>as", "<Plug>(coc-codeaction-source)", { silent = true, nowait = true, desc = "Codeaction source" })
